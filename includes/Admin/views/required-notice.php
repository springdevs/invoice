<div class="notice notice-error sdevs-install-plugin">
	<div class="sdevs-notice-icon">
		<img src="<?php echo esc_attr( PIPS_ASSETS . '/images/woocommerce.png' ); ?>" alt="woocommerce-logo" />
	</div>
	<div class="sdevs-notice-content">
		<h2><?php esc_html_e( 'Thanks for using PDF Invoices & Packing Slips', 'sdevs_pips' ); ?></h2>
