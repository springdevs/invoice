...
class Email {
	...
	public function __construct() {
		add_filter( 'woocommerce_email_attachments', array( $this, 'include_pdf_with_email' ), 10, 4 );
	...
	public function include_pdf_with_email( $attachments, $email_id, $order, $email ) {
		...
		if ( 'yes' === get_option( 'pips_free_order_invoice', 'no' ) ) {
			return $attachments;
		}
